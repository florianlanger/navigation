...
class MixtureDensityNetwork(nn.Module):
    ...
    def forward(self,descriptions,length_descriptions):
        ...
        packed_input = pack_padded_sequence(embeds, length_descriptions, batch_first=True,enforce_sorted=False)
