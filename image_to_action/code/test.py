...
#sys.path.append(os.path.abspath("/home/mlmi-2019/fml35/Documents/mphil_project/experiments_all/3d_grid_equidistance/code/graphs"))
from data.data_loader import Dataset, load_data_set, Sampler
from graphs.conversions import Converter
from utilities import write_to_file, load_config, load_model
from plots import show_images, visualise_pairs
...
def perform_test(network,max_moves,config,dataset,sampler,converter):
    ...
    while counter < max_moves:
        ...
        #show_images(images,'experiments/exp_13_penalty_1_time_15_20_50_date_30_04_2020/visualisations/debug{}.png'.format(counter))
